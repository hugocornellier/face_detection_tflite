...
* Update flutter_litert -> 3.2.1 (Android Gradle Plugin 9.x build fix; faster `Interpreter.run`/`CompiledModel.run` and fewer per-frame allocations in the camera YUV path). No API change.
